...
const char * const BITCOIN_CONF_FILENAME = "grdp.conf";
const char * const BITCOIN_PID_FILENAME = "grdp.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Groundpluscoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Groundpluscoin";
#else
    // Unix
    return pathRet / ".grdp";
#endif
