...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s grdp-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  grdp-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded grdp transaction") + "\n" +
              "  grdp-tx [options] -create [commands]   " + _("Create hex-encoded grdp transaction") + "\n" +
              "\n";
